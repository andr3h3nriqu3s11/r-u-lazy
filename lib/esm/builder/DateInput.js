...
export function DateInputBuilder(BaseDateInput, Wraper, ls) {
    var DateInput = function (_a) {
        ...
        return (React.createElement(Wraper, { id: id, label: label, hidden: hidden, class: labelClass, gridless: gridless },
            React.createElement("div", { className: inputClass },
                React.createElement(BaseDateInput, { selectionMode: selectionMode, hourFormat: ls('hourFomart', 'default', hourFormat !== null && hourFormat !== void 0 ? hourFormat : ''), showTime: showTime, timeOnly: timeOnly, minDate: minDate, maxDate: maxDate, yearRange: "1900:" + (new Date().getFullYear() + 10), monthNavigator: true, yearNavigator: true, id: id, dateFormat: "dd-mm-yy", value: value, onChange: function (event) { return (onChange !== null && onChange !== void 0 ? onChange : (function () { }))(event); }, disabled: disabled }))));
    };
    return DateInput;
}
