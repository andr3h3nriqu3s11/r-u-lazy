...
exports.InputMaskBuilder = void 0;
var react_1 = __importDefault(require("react"));
function InputMaskBuilder(BaseInputMask, Wraper, ls) {
    var InputMask = function (props) {
        ...
        return (react_1.default.createElement(Wraper, { id: id, label: label, hidden: hidden, class: labelClass, gridless: gridless },
            react_1.default.createElement("div", { className: fieldClass },
                react_1.default.createElement(BaseInputMask, { placeholder: placeholder, tooltip: tooltip, value: value, onChange: function (e) {
...
exports.InputMaskBuilder = InputMaskBuilder;
